...
// Подключение twig, если будем использовать его
...
$config = include $_SERVER['DOCUMENT_ROOT'] . "/PHP-Homework/Professional-2/config/main.php";
\sukhinin\app\base\App::call()->run($config);
\sukhinin\app\base\App::call()->createComponent("index");
