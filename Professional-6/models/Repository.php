...
abstract class Repository {
    ...
    public function getOne($id){
        ...
        $result = $this->_db->queryObject($sql, [":id" => $id], $this->getEntityClass());
    ...
    public function getAll(){
        ...
        $result = $this->_db->queryObject($sql, [], $this->getEntityClass());
    ...
    public function insert(\sukhinin\app\models\DataEntity $entity){
        ...
        $entity->id = $this->_db->lastInsertId();
        return true;
    }
    ...
    public function delete(\sukhinin\app\models\DataEntity $entity){
        ...
        return $this->_db->execute($sql, [':id' => $entity->id]);
    }
